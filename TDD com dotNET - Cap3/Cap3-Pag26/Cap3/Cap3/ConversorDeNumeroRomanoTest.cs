...
namespace Cap3
{
    ...
    public class ConversorDeNumeroRomanoTest
    {
        static void Main()
        {
            ...
            teste.DeveEntenderOSimboloII();
            teste.DeveEntenderOSimboloV();
            teste.DeveEntenderNumerosComoIX();
            teste.DeveEntenderQuatroSimbolosDoisADoisComoXXII();
            teste.DeveEntenderNumerosComplexosComoXXIV();
